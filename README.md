...
WaterAlert est une solution professionnelle de gestion et de monitoring des fuites d'eau. Elle combine un Bot Telegram pour le signalement citoyen et un tableau de bord analytique avancé propulsé par l'IA.
...
- **Exportation de données** : Download des données filtrées en CSV pour Excel.

### 🧠 Intelligence Artificielle (IA) Réelle
...
└── requirements.txt    # Dépendances (Streamlit, Folium, Plotly, Gemini)
```
